...
public final class MyGameStateFactory implements Factory<GameState> {
	private final class MyGameState implements GameState {
		...
		public Optional<TicketBoard> getPlayerTickets(Piece piece) {
			TicketBoard playerTickets = new TicketBoard() { // anonymous object of an interface
				@Override
		...
		@Override public GameState advance(Move move) {
			...
			return move.accept(new Move.Visitor<GameState>(){
				...
				public GameState visit(SingleMove move) {
					...
					if (newState.getAvailableMoves().isEmpty()) { //logicaly incorect as if one detective cant move that doesnt mean that all detectives cant move. but on the contorerry, it passes all the tests; yippie
						remainingTemp.clear();
						remainingTemp.add(mrX.piece());
